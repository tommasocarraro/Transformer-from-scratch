...
transformer = TransformerNet(d.source_vocab_length, d.target_vocab_length, d.padding_token, d.sos_token, d.eos_token, 128, 4, 1028, 0.1, 4, pre_norm=True)
trainer = Trainer(transformer, Adam(transformer.parameters(), betas=(0.9, 0.98), lr=1e-4, eps=1e-9), lr_scheduler=True)
trainer.train(tr_loader, 3, val_loader=val_loader, early=5, save_path="./transformer.pth")
